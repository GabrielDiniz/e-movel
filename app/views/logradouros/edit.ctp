...
<?php echo $this->Form->create('Logradouro');?>
	<fieldset>
		<legend><?php __('Edit Logradouro'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Logradouro.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Logradouro.id'))); ?></li>
