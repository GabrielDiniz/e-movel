...
<?php echo $this->Form->create('ValorAluguel');?>
	<fieldset>
		<legend><?php __('Edit Valor Aluguel'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ValorAluguel.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ValorAluguel.id'))); ?></li>
